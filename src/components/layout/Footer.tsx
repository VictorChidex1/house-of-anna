        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-sm text-white/60 leading-relaxed">
              Bespoke tailoring and fashion design — crafting elegance for every occasion.
            </p>
          </div>

          <div>
            <h4 className="text-xs tracking-widest uppercase text-brand-gold mb-3">Navigate</h4>
          ...
          <div>
            <h4 className="text-xs tracking-widest uppercase text-brand-gold mb-3">Connect</h4>
