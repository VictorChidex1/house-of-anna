    ...
    <div className="min-h-screen bg-brand-cream">
        ...
        jsonLd={{
          ...
          itemListElement: [
            ...
            },
            {
              ...
              position: 2,
              name: "Contact",
              item: "https://house-of-anna.vercel.app/contact",
            },
          ],
        }}
      />
      ...
      <section className="py-24 px-4 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          >
            <h2 className="font-serif text-3xl sm:text-4xl text-brand-dark mb-6">
              Studio Information
            </h2>
            <p className="text-brand-gray leading-relaxed mb-12 max-w-md">
              Whether you are ready to begin your bespoke journey or simply have
              a question about our collections, we would love to hear from you.
            </p>

            <div className="space-y-8 mb-12">
              <div>
                <h4 className="text-xs tracking-[0.2em] uppercase text-brand-gold mb-2 font-medium">
                  Location
                </h4>
                <p className="text-brand-dark font-light text-lg">
              ...
              <div>
                ...
                <a
                  ...
                  className="text-brand-dark font-light text-lg hover:text-brand-gold transition-colors"
                >
            ...
            {isSuccess ? (
              ...
              >
                ...
                <p className="text-brand-gray leading-relaxed">
                  Thank you for your interest in House of Anna. We have received
                  your inquiry and Anna will be in touch with you shortly to
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  <div className="relative group">
                    <input
                      ...
                      className="peer w-full bg-transparent border-b border-brand-gold/30 py-3 text-brand-dark focus:outline-none focus:border-brand-gold placeholder-transparent transition-colors"
                      placeholder="Full Name"
                    />
                    <label
                      htmlFor="name"
                      className="absolute left-0 -top-3.5 text-xs text-brand-gray/70 transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-brand-gray/50 peer-placeholder-shown:top-3 peer-focus:-top-3.5 peer-focus:text-xs peer-focus:text-brand-gold tracking-widest uppercase"
                    >
                      Full Name
                    </label>
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  ...
                  <div className="relative group">
                    <select
                      ...
                      onChange={handleChange}
                      className="peer w-full bg-transparent border-b border-brand-gold/30 py-3 text-brand-dark focus:outline-none focus:border-brand-gold transition-colors appearance-none rounded-none"
                    >
                      <option value="Bespoke Gown">Bespoke Gown</option>
                      <option value="Corporate Wear">Corporate Wear</option>
                      <option value="Traditional/Ankara">
                        Traditional/Ankara
                      </option>
                    ...
                    <div className="absolute right-0 top-1/2 -translate-y-1/2 pointer-events-none text-brand-gold/50">
                      ▼
                    </div>
                    <label
                      htmlFor="serviceType"
                      className="absolute left-0 -top-3.5 text-xs text-brand-gray/70 tracking-widest uppercase"
                    >
                      Service Type
                    </label>
                  </div>
                ...
                <div className="relative group pt-4">
                  <textarea
                    ...
                    onChange={handleChange}
                    className="peer w-full bg-transparent border-b border-brand-gold/30 py-3 text-brand-dark focus:outline-none focus:border-brand-gold placeholder-transparent transition-colors resize-none"
